...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("penerjemah bahasa isyarat tangan")
        ...
        self.T.config(text="penerjemah bahasa isyarat tangan", font=("Courier", 30, "bold"))
        ...
        self.T1.config(text="Huruf :", font=("Courier", 30, "bold"))
        ...
        self.T3.config(text="Kalimat :", font=("Courier", 30, "bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x=10, y=700)
        self.T4.config(text="perkiraan :", fg="red", font=("Courier", 30, "bold"))
        ...
        self.clear.config(text="Hapus", font=("Courier", 20), wraplength=100, command=self.clear_fun)
